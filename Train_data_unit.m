function Train_data_unit(imgprop,i)
addpath('D:\Program Files\MATLAB\R2011a\toolbox\matlab tool box');
dirimg = 'E:\2012 文字检测\测试集\ICADR 2003\SceneTrialTrain\';
dirresult = 'E:\2012 文字检测\实验结果\训练结果\';
color = 1;
disp(['start to compute the image of ' num2str(i)])
imgname = [dirimg imgprop{i}.name];
...
[flag_pn] = Positive_negative(cpoint_cell_p,imgprop{i});
