function [RLearners RWeights] = Train_2011_Hog_Pre()
clear
close all
clc
...
for i = 1:num_img
    ...
    edge_img = Compute_edge(img,sqrt(2));
    feature_all = GetNegSample(edge_img, img, position);
    FeatureNeg = [FeatureNeg;feature_all];
    fclose(fid);
